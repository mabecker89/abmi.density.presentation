...
### The ABMI uses a version of the REST model to estimate animal density from camera traps

REST = <ins>**R**</ins>andom <ins>**E**</ins>ncounter <ins>**S**</ins>taying <ins>**T**</ins>ime

Central Tenets:

+ Images taken at discrete intervals are turned into a record of continuous time

+ A zone of detection (*Effective Detection Distance*) for each camera / habitat / species combination is defined
...
ABMI report: [Animal Density with Cameras](www.abmi.ca)
...
- In order to make inferences about a larger area, cameras are placed across the landscape in a random systematic manner

- Because of this, the data we collect has frightful distributions

- More data is better, as we can improve the precision of our density estimates for an area of interest
...
Let's pick out a subset (yes, I'm cherry-picking to illustrate my point):
+ WMU
+ WMU
+ WMU
+ WMU
...
Here's what we have for camera deployments in these four WMUs:
...
Here's how we estimate density:
