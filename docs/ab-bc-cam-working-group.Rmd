...
.pull-right[
```{r eval=TRUE, echo=FALSE, include=TRUE, fig.height=9}
...
```{r eval=FALSE, echo=FALSE, include=FALSE, message=FALSE, warning=FALSE, out.width='100%', fig.height=7}
library(leaflet)
library(dplyr)
...
map <- ab_wmu_selection %>%
  ...
  addAwesomeMarkers(data = sf_abmi_selection, icon = cam_abmi) %>%
  ...
  addLayersControl(overlayGroups = c("Bayne Big Grid", "Caribou Monitoring Unit"),
                   options = layersControlOptions(collapsed = FALSE)) %>%
  hideGroup(c("Bayne Big Grid", "Caribou Monitoring Unit"))

htmlwidgets::saveWidget(map, file = here("./docs/map.html"), selfcontained = TRUE)

```

<iframe src="map.html" width="700" height="500"> </iframe>
